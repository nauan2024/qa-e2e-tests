describe('template spec', () => {
  ...
  it("Login cpf", () => {
    ...
    cy.get("#document").type("94419337400").should("have.value", "944.193.374-00")
    //escolhe a formatação exata do cpf, se não estiver exatamente assim não será aceito

   
    

    cy.get("technologies").type("Abacom").should("have.value", "Abacom").type("{enter}")
